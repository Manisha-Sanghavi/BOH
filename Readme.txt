Install PyCharm professional edition to work with Behave

Clone repo
Install dependencies by running "pip && pip install -r requirements.txt"
...
Example - behave Features/Feature1.feature -f allure_behave.formatter:AllureFormatter -o Report_Json
